...
/* =============================== 按键 (按下为低) =============================== */
/* 按键数量由产品型号决定 (见 app_config.h):
 *   外挂款: 5 个 (PA02 PA04 PA05 PA06 PB03, PA00/PA01 被检测占用)
 *   内置款: 7 个 (PA00 PA01 PA02 PA04 PA05 PA06 PB03) */
#if BSP_DETECT_ENABLED
#define BTN_MAX_NUM          5
static const GPIO_TypeDef *const BTN_PORT[BTN_MAX_NUM] = { CW_GPIOA, CW_GPIOA, CW_GPIOA,
                                                           CW_GPIOA, CW_GPIOB };
static const uint16_t BTN_PIN[BTN_MAX_NUM] = { GPIO_PIN_2, GPIO_PIN_4, GPIO_PIN_5,
                                               GPIO_PIN_6, GPIO_PIN_3 };
#else
#define BTN_MAX_NUM          7
static const GPIO_TypeDef *const BTN_PORT[BTN_MAX_NUM] = { CW_GPIOA, CW_GPIOA, CW_GPIOA,
                                                           CW_GPIOA, CW_GPIOA, CW_GPIOA,
                                                           CW_GPIOB };
static const uint16_t BTN_PIN[BTN_MAX_NUM] = { GPIO_PIN_0, GPIO_PIN_1, GPIO_PIN_2,
