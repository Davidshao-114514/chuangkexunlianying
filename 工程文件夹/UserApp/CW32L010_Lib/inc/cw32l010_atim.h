...
#define ATIM_IT_CC6IE                          (1UL << 17)
#define ATIM_IT_CC5IE                          (1UL << 16)
...
#define IS_ATIM_SLAVER_TYPE(TYPE)              ((TYPE) <= 0x0F)
...
#define ATIM_TS_ITR4                         (0x00000001UL << ATIM_SMCR_TSH_Pos)                              /*!< Internal Trigger 4 (ITR4) is used as trigger input */
